...
final class LittleEndianByteArray {
  ...
  /**
   * The instance that actually does the work; delegates to Unsafe, or a Java-8
  ...
  /**
   * Indicates that the load and store operations will be very efficient because of use of 
   * Unsafe. May be useful for calling code to fall back on an alternative implementation that is
