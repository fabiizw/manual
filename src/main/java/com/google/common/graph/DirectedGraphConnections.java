 ...
 */
public  class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
  /**
   * A wrapper class to indicate a node is both a predecessor and successor while still providing
   * the successor value.
   */
  public static  class PredAndSucc {
    public  Object successorValue;
   ...
   */
  public abstract static class NodeConnection<N> {
     N node;
    ...
    static  class Pred<N> extends NodeConnection<N> {
      Pred(N node) {
        super(node);
      }
    ...
    static  class Succ<N> extends NodeConnection<N> {
      Succ(N node) {
        super(node);
      }
  ...
  public static  Object PRED = new Object();
  ...
  public  Map<N, Object> adjacentNodeValues;
   ...
   */
  public  @Nullable List<NodeConnection<N>> orderedNodeConnections;

  public int predecessorCount;
  public int successorCount;

  public DirectedGraphConnections(
