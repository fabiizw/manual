 ...
 * Most of the utility methods required by subclasses are package-public,
...
public abstract class BasicChronology extends AssembledChronology {
    ...
    public static final int CACHE_SIZE = 1 << 10;
    public static final int CACHE_MASK = CACHE_SIZE - 1;

    public transient final YearInfo[] iYearInfoCache = new YearInfo[CACHE_SIZE];

    public final int iMinDaysInFirstWeek;

    public BasicChronology(Chronology base, Object param, int minDaysInFirstWeek) {
        super(base, param);
    ...
    public long getDateTimeMillis0(int year, int monthOfYear, int dayOfMonth, int millisOfDay) {
