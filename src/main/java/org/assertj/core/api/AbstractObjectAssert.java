...
public abstract class AbstractObjectAssert<SELF extends AbstractObjectAssert<SELF, ACTUAL>, ACTUAL>
  ...
  public AbstractObjectAssert<?, ?> extracting(String propertyOrField) {
    return extracting(propertyOrField, value -> (AbstractObjectAssert<?, ?>) newObjectAssert(value));
  }
   ...
   */
  @CheckReturnValue
  public <T, ASSERT extends AbstractAssert<?, ?>> ASSERT extracting(String propertyOrField,
                                                                   InstanceOfAssertFactory<?, ASSERT> assertFactory) {
    // Extract the property/field value
    Object extractedValue = byName(propertyOrField).apply(actual);
    // Create the appropriate assertion
    return newObjectAssert(extractedValue).asInstanceOf(assertFactory);
  }
  ...
  public <T> AbstractObjectAssert<?, T> extracting(Function<? super ACTUAL, T> extractor) {
    T extracted = extractor.apply(actual);
    return newObjectAssert(extracted);
  }
  ...
  public <T, ASSERT extends AbstractAssert<?, ?>> ASSERT extracting(Function<? super ACTUAL, T> extractor,
                                                                    InstanceOfAssertFactory<?, ASSERT> assertFactory) {
    T extracted = extractor.apply(actual);
    return newObjectAssert(extracted).asInstanceOf(assertFactory);
  }
