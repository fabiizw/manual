...
public class Assertions implements InstanceOfAssertFactories {
 ...
 @SuppressWarnings({"unchecked", "rawtypes"})
  public static <T> Condition<T> allOf(List<? extends Condition<? super T>> conditions) {
    return AllOf.allOf((Iterable) conditions);
  }
   ...
   */
 @SuppressWarnings({"unchecked", "rawtypes"})
  public static <T> Condition<T> anyOf(List<? extends Condition<? super T>> conditions) {
    return AnyOf.anyOf((Iterable) conditions);
  }
