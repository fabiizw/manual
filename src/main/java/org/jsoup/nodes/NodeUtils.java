...
public class NodeUtils {
     ...
     */
    public static <T extends Node> List<T> selectXpath(String xpath, Element el, Class<T> nodeType) {
    ...
    public static <T extends Node> Stream<T> stream(Node start, Class<T> type) {
    ...
    public static <T extends Node> Spliterator<T> spliterator(Iterator<T> iterator) {
