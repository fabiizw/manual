...
public abstract class BasePackConnection extends BaseConnection {
	...
	public static final String CAPABILITY_SYMREF_PREFIX = "symref="; //$NON-NLS-1$
	...
	public final Set<ObjectId> additionalHaves = new HashSet<>();
	 ...
	 *            suffer.
	 */
	public final void init(InputStream myIn, OutputStream myOut) {
	 ...
	 */
	public void lsRefs(Collection<RefSpec> refSpecs,
	 ...
	 *         possibly why.
	 */
	public TransportException noRepository(Throwable cause) {
	 ...
	 */
	public boolean isCapableOf(String option) {
	 ...
	 */
	public boolean wantCapability(StringBuilder b, String option) {
	 ...
	 */
	public String getCapability(String option) {
	 ...
	 */
	public void addUserAgentCapability(StringBuilder b) {
